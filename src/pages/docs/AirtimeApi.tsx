...
export default function AirtimeApi() {
  const requestPayload = `{
  "network": "MTN",
  "amount": 100,
  "phone": "08142452729",
  "request_id": "REF_123456"
}`;
  ...
  return (
    ...
    >
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-4xl font-black tracking-tight text-gray-900">Airtime API</h1>
      </div>

      <p className="text-lg text-gray-500 leading-relaxed">
        Purchase airtime for all major networks in Nigeria (MTN, Airtel, Glo, 9mobile).
      </p>
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <code className="text-blue-700 font-mono">/airtime/purchase</code>
        </div>
      </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm">
            ...
            <tbody className="divide-y divide-gray-50">
              ...
              <tr>
                <td className="py-4 font-mono text-blue-700">amount</td>
                <td className="py-4 text-gray-500 italic">number</td>
                <td className="py-4 text-gray-600">The amount of airtime to purchase (₦)</td>
              </tr>
              <tr>
      ...
      <div className="pt-8 border-t border-gray-100 flex justify-between items-center">
        ...
        <Link to="/developer/docs/data" className="flex items-center gap-2 text-blue-700 font-bold hover:underline">
          Next: Data API
