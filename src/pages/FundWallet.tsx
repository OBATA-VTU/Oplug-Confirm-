...
import { Wallet, CreditCard, Landmark, Copy, CheckCircle2, Upload, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="bg-white rounded-[2.5rem] p-8 shadow-sm border border-gray-100">
        <h2 className="text-2xl font-bold mb-8 tracking-tight">Fund Your Wallet</h2>
            ...
            >
              <div className="p-6 bg-blue-50 rounded-3xl border border-blue-100">
                <p className="text-sm text-blue-700 leading-relaxed">
                  Transfer to any of your permanent virtual accounts below to fund your wallet instantly. 
                  <span className="font-bold block mt-2">Note: A ₦50 charge applies to each deposit.</span>
                </p>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {profile?.virtualAccounts?.map((acc: any, i: number) => (
                  <div key={i} className="bg-gray-900 text-white rounded-[2rem] p-8 relative overflow-hidden group">
                    <div className="relative z-10">
                      <div className="flex justify-between items-start mb-8">
                        <div>
                          <p className="text-[10px] opacity-60 uppercase tracking-widest mb-1">Bank Name</p>
                          <p className="text-xl font-bold">{acc.bank_name}</p>
                        </div>
                      ...
                      <div className="mb-8">
                        ...
                        <div className="flex items-center gap-3">
                          <p className="text-3xl font-mono font-bold tracking-wider">{acc.account_number}</p>
                          <button 
